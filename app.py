...
def generate_monthly_status_report(model_name: str, master_content: str, example_content: str) -> str:
    ...
    - Make sure to separate the work of each person.
...
def generate_monthly_status_report(model_name: str, master_content: str, example_content: str) -> str:
    ...
    Do not:
    - Return the markdown tag(```markdown)
    - Combine work of two people into 1 block.
...
input_directory = "./data_files/inputs/TO4_LFD_LeasedFacilitiesDivision"
